...
class BDTDAgent:
    ...
    def __init__(self, subject: str, max_pages_limit: int = 50, download_pdf: bool = False):
        ...
        self.output_csv = os.path.join("output", "results.csv")
        self.filtered_csv = os.path.join("output", "results_filtered.csv")
        self.page_details_csv = os.path.join("output", "results_page.csv")
    ...
    def download_pdfs(self, csv_path: str):
        ...
        for idx, row in df.iterrows():
            ...
            pdf_subfolder = os.path.join("output", folder_name)
...
#     """
#     Classe principal que integra a lógica de pesquisa na BDTD, filtragem de resultados
#     e download de arquivos, armazenando tudo na pasta 'output'.
#     """
...
#     def run_crawler(self) -> str:
#         """
#         Executa o BDTDCrawler em múltiplas páginas até o limite definido
#         e salva o resultado consolidado em um arquivo CSV final (self.output_csv).
...
#     def filter_by_subject(self, csv_path: str) -> str:
#         """
#         Filtra o CSV, mantendo apenas as linhas cujo 'title' contenha 
#         ao menos uma das palavras passadas em self.subject.
...
#         for idx, row in df.iterrows():
#             rec_id = str(row.get("id", "no_id"))
#             # Neste exemplo, usamos apenas o 'id' para nomear a pasta
#             folder_name = self.sanitize_folder_name(rec_id)
#             pdf_subfolder = os.path.join("output", folder_name)
...
#           1) Busca com BDTDCrawler (multi-páginas) e salva em 'output/results.csv'.
#           2) Filtra o CSV em 'output/results_filtered.csv' pelas palavras de self.subject.
#           3) (Opcional) Faz download dos arquivos em pastas separadas.
#           4) (Opcional) Ao final, executa o sanity check para remover PDFs indesejados.
#         """
#         print(f"==> Iniciando busca para o assunto: '{self.subject}'")
#         print(f"==> Número máximo de páginas: {self.max_pages_limit}")
#         print(f"==> Download de PDFs ativado? {self.download_pdf}")
...
#     """
#     parser = argparse.ArgumentParser(
#         description="Agente para busca na BDTD e download de PDFs conforme um assunto."
#     )
#     parser.add_argument(
#         "subject",
#         type=str,
